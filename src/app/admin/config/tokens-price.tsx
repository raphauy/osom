    ...
    return (
        <div className="w-full p-4 border rounded-lg">
            ...
            <div className="flex items-end gap-4 pb-3 mb-3 border-b">
                <p className="mt-5"><strong>Prompt Tokens Price:</strong> {promptTokensPrice ? Intl.NumberFormat("es-UY", { style: "currency", currency: "USD"}).format(promptTokensPrice) : "N/D"}</p>
                <p className="mt-5"><strong>Completion Tokens Price:</strong> {completionTokensPrice ? Intl.NumberFormat("es-UY", { style: "currency", currency: "USD"}).format(completionTokensPrice) : "N/D"}</p>
