        ...
        <div className="flex flex-1 gap-6 pl-5 md:gap-5 ">
            <nav>
                <ul className="flex items-center">
                    ...
                    <li className={`flex items-center border-b-white hover:border-b-white hover:border-b-2 h-11 ${path.includes("tablero") && "border-b-2"}`}>
                        <Link href="/tablero"><Button className="text-lg" variant="ghost">Tablero</Button></Link>
                    </li>
                </ul>
            </nav>
        </div>
